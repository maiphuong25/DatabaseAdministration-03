...
INSERT INTO KhachHang VALUES ('KH10777','Han','Cẩm Lệ','0986578989','2002-05-05')

select * from KhachHang

/*2: Kiểm tra khách hàng đã có trong cơ sở dữ liệu chưa? Nếu chưa thì tạo mã khách hàng mới, 
nếu rồi thì sử dụng tiếp mã khách hàng đã có. va tao ma DH moi*/
...
FROM dbo.fTaoMaDHvaMaKH( 
    N'Pham Dinh Khoi Nguyen A',   -- Tên khách hàng mới
    '2024-10-20'
);
...
INSERT INTO #Products (MaSP, SoLuong) VALUES ('SP0001', 1);  
INSERT INTO #Products (MaSP, SoLuong) VALUES ('SP0002', 2);
INSERT INTO #Products (MaSP, SoLuong) VALUES ('SP0003', 1);
GO

EXEC sp_TaoHoaDonMoi @TenKH = 'Jisoo', @MaNV = 'NV00000009' ,@DChi = 'Korea', @SDT = '0987854610', @NSinh = '2004-01-25'
GO
